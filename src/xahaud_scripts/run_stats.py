...
def main(
    ...
    with _session() as session:
        ...
        if row.count == 0:
            ...
            click.echo(f"No runs recorded ({label}).")
            return
        ...
        console.print(f"\n[bold]{label}[/bold]: {row.count} runs")
        console.print(
        ...
        console.print(f"  Total: {_fmt_duration(row.total)}")
        if row.interrupted:
            console.print(f"  Interrupted: {row.interrupted}")
        console.print()
